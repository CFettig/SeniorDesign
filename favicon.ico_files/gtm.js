...
"resource": {
  ...
  "rules":[
    ...
    [["if",1,17],["add",19]],
    [["if",1,2],["unless",6],["add",20,22,26,61]],
    [["if",1],["unless",2,6],["add",21,27,30,33,37,38,39,40,41,43,44,46,48,49,50,51,53,54,55,56]],
    ...
    [["if",1,22],["add",52]],
    [["if",23],["add",57]],
    [["if",1],["unless",2,24,25,26,27],["add",59]]]
},
"runtime":[]
...
var Ld=[C.B,C.J],Md=function(a){var b=a[C.Qd];b&&D(40);var c=a[C.Rd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Qd&&f!==C.Rd)if(-1<Ga(Ld,f)){var h=f,k=a[f],l=d[e];wd().set(h,k,l,"US","US-IL",c)}else{}},Nd=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
t[0],x;if(G.location){var z=ie(G.location,"host",!0);x=0<=v.toLowerCase().indexOf(z)}else x=!1;x||q.push({element:r,Kc:v})}}}var w=te(q),y=[];if(w){var A=w.element;y.push({Kc:w.Kc,querySelector:re(A),tagName:A.tagName,isVisible:!Wd(A),type:1,ff:!0})}return{elements:y,status:10<q.length?"3":l.status}}var Ie={},L=null,Je=Math.random();Ie.D="GTM-5W9QXH7";Ie.mc="3v0";Ie.Ih="";Ie.Ef="ChEI8Pa/gwYQkO2s6sv0ktPQARIkALcoIDkXfoaaKxoYtWLhZrLzCH1Gx2+0BVCUGtQeA2et5VnkGgIdRw\x3d\x3d";var Ke={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Le={__paused:!0,__tg:!0},Me;for(Me in Ke)Ke.hasOwnProperty(Me)&&(Le[Me]=!0);var Ne="www.googletagmanager.com/gtm.js";
var Oe=Ne,Pe=Qa(""),Qe=null,Re=null,Se="//www.googletagmanager.com/a?id="+Ie.D+"&cv=229",Te={},Ue={},Ve=function(){var a=L.sequence||1;L.sequence=a+1;return a};Ie.Df="";var We={},Xe=new Ka,Ye={},Ze={},bf={name:"GTMDataLayer",set:function(a,b){m(hb(a,b),Ye);$e()},get:function(a){return af(a,2)},reset:function(){Xe=new Ka;Ye={};$e()}},af=function(a,b){return 2!=b?Xe.get(a):cf(a)},cf=function(a){var b,c=a.split(".");b=b||[];for(var d=Ye,e=0;e<c.length;e++){if(null===d)return!1;if(void 0===d)break;d=d[c[e]];if(-1!==Ga(b,d))return}return d},df=function(a,b){Ze.hasOwnProperty(a)||(Xe.set(a,b),m(hb(a,b),Ye),$e())},$e=function(a){Ma(Ze,function(b,c){Xe.set(b,c);m(hb(b,
...
w(z);break a}}f=void 0}if(!f){Gm=!1;continue}}a=Jm(f)||a}}finally{h&&$e(!0)}}Gm=!1}return!a}function Mm(){var a=Lm();try{hm(G["GTMDataLayer"],Ie.D)}catch(b){}return a}
var Om=function(){var a=fd("GTMDataLayer",[]),b=fd("google_tag_manager",{});b=b["GTMDataLayer"]=b["GTMDataLayer"]||{};fi(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});Xl(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var e;if(0<L.SANDBOXED_JS_SEMAPHORE){e=[];for(var f=0;f<arguments.length;f++)e[f]=new Cm(arguments[f])}else e=[].slice.call(arguments,0);var h=c.apply(a,e);Dm.push.apply(Dm,e);if(300<
...
(void 0===G[a]||c&&!G[a])&&(G[a]=b);return G[a]},qn=function(a,b,c){return tf(a,b,void 0===c?!0:!!c)},rn=function(a,b,c){return 0===Ff(a,b,c)},sn=function(a,b){if(sh()){b&&J(b)}else jd(a,b)},tn=function(a){return!!Pl(a,"init",!1)},un=function(a){Nl(a,"init",!0)},vn=function(a){var b=Oe+"?id="+encodeURIComponent(a)+"&l=GTMDataLayer";O(uh("https://","http://",b))},wn=function(a,b,c){Yi&&(rb(a)||aj(c,b,a))};var xn=Pm.ph;function Un(a,b){a=String(a);b=String(b);var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c}var Vn=new Ka;function Wn(a,b,c){var d=c?"i":void 0;try{var e=String(b)+d,f=Vn.get(e);f||(f=new RegExp(b,d),Vn.set(e,f));return f.test(a)}catch(h){return!1}}
